...
<!-- add retrieval job modal -->
<div class="modal fade" id="addRetrievalJobModalAdmin" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span></button>
        <h3 class="modal-title"><?=$lang['add']['retrievaljob'];?></h3>
      </div>
      <div class="modal-body">
        <p class="help-block"><?=$lang['add']['retrievaljob_hint'];?></p>
        <form class="form-horizontal" data-cached-form="true" role="form" data-id="add_retrievaljob">
          <div class="form-group">
            <label class="control-label col-sm-2" for="username"><?=$lang['add']['username'];?>:</label>
            <div class="col-sm-10">
              <select data-live-search="true" name="username" required>
          ...
          <div class="form-group">
            <label class="control-label col-sm-2" for="protocol"><?=$lang['add']['protocol'];?></label>
            <div class="col-sm-10">
              <select name="protocol" title="<?=$lang['add']['select'];?>" required>
                <option selected>POP3</option>
                <option>IMAP</option>
              </select>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2" for="host"><?=$lang['add']['hostname'];?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" class="form-control" name="port" min="1" max="65535" value="995" required>
              <small class="help-block">1-65535</small>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2" for="user"><?=$lang['add']['username'];?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <div class="checkbox">
                <label><input type="checkbox" value="1" name="delete"> <?=$lang['add']['delete1'];?></label>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <div class="checkbox">
                <label><input type="checkbox" value="1" name="read_all"> <?=$lang['add']['read_all'];?></label>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <div class="checkbox">
                <label><input type="checkbox" value="1" name="use_ssl" checked> <?=$lang['add']['use_ssl'];?></label>
              </div>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <button class="btn btn-default" data-action="add_item" data-id="add_retrievaljob" data-api-url='add/retrievaljob' data-api-attr='{}' href="#"><?=$lang['admin']['add'];?></button>
            </div>
          </div>
        </form>
      </div>
...
<div class="modal fade" id="retrievaljobLogModal" tabindex="-1" role="dialog" aria-labelledby="retrievaljobLogModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header"><h4 class="modal-title">Log</h4></div>
      <div class="modal-body">
